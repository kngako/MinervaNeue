...
class SkinMinerva extends SkinTemplate {
	...
	protected function preparePageActions( BaseTemplate $tpl ) {
		...
		if ( $this->isAllowedPageAction( 'edit' ) ) { // TODO: This must
			$actions = $tpl->data['content_actions']['edit'];
			$menu['edit'] = $this->createEditPageAction($actions);
		}
	 ...
	 */
	protected function createEditPageAction($actions) {
		$title = $this->getTitle();
